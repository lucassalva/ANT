...
public class listaPecesL extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(listaPecesL.this, peces_del_lugar.class);
                id_lugar = id;
        ...
        buttonCargar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(listaPecesL.this, cargarLugar.class);
                startActivity(intent);
            }
        });
        ...
        buttonVolver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(listaPecesL.this, MainActivity.class);
                startActivity(intent);
            }
        });
